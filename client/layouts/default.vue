<template>
  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <aside
      v-if="isTablet"
      class="tablet-sidebar fixed left-0 top-16 bottom-0 w-[260px] z-40 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 overflow-y-auto transition-transform duration-300"
    ...
    >
      <div class="p-4 space-y-4">
        ...
        <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
          <h3 class="px-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">分类</h3>
          <div class="space-y-1">
        ...
        <!-- 热门标签 -->
        <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
          <h3 class="px-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">热门标签</h3>
    ...
    <Transition name="fade">
      <div
        ...
        class="fixed inset-0 top-16 bg-black/30 z-39"
    ...
    <!-- 主内容区 -->
    <main
      class="pt-16 pb-16 md:pb-0 transition-all duration-300"
      :class="{
    ...
    <Transition name="fade">
      <div v-if="showOrientationPrompt" class="orientation-prompt-overlay" @click.self="dismissOrientationPrompt">
        <div class="orientation-prompt-card">
          ...
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">旋转屏幕</h3>
