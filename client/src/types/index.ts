...
export interface UserSettingsPrivacy {
  ...
  contentRecommend: number  // 内容推荐：0-关闭，1-开启
  autoPlayVideo: number     // 自动播放视频：0-关闭，1-仅WiFi，2-始终
  quietHoursEnabled: number // 免打扰开关：0-关闭，1-开启
  quietHoursStart: string   // 免打扰开始时间 HH:mm
  quietHoursEnd: string     // 免打扰结束时间 HH:mm
  showViewCount: number     // 显示阅读量：0-关闭，1-开启
  allowSearch: number       // 允许被搜索：0-关闭，1-开启
}
